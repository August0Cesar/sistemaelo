		...
		<div class="row">
			<div class="col-sm-3 col-md-2 sidebar">
				<ul class="nav nav-sidebar">
					<li><a href="cadastroDizimoOfertas">Cadastro de Dízimos e
							Ofertas</a></li>

					<li><a href="listaDizimoOfertas">Lista de Dízimos e
							Ofertas</a></li>
				</ul>
			</div>
			<div class="col-sm-9 main">
				<form class="well form-horizontal" id="" action="cadastroDizimoOfertas">
					<fieldset>
						<legend>Cadastro de Dizimos e Ofertas</legend>
						<div class="form-group">
							<label class="col-md-4 control-label">Dízimo ou Oferta?</label>
							<div class="col-md-4">
								<div class="radio">
									<label> <input type="radio" 
										name="dizimo" value="true" /> Dízimo
									</label>
								</div>
								<div class="radio">
									<label> <input type="radio" 
										name="dizimo" value="false" /> Oferta
									</label>
								</div>
							</div>
						</div>
							...
							<div class="col-md-4 inputGroupContainer">
								<div class="input-group">
									<span class="input-group-addon"><i
										...
										name="data_dizimo_oferta" id="data_dizimo_oferta"
						...
						<div class="form-group">
							...
							<div class="col-md-4 inputGroupContainer">
								<div class="input-group">
									<span class="input-group-addon"><i
										class="glyphicon glyphicon-usd"></i></span> <input name="valor"
										id="valor" placeholder="Digite número de pessoas"
						...
						<div class="form-group">
							...
							<div class="col-md-4 selectContainer">
								<div class="input-group">
									<span class="input-group-addon"><i
										class="glyphicon glyphicon-list"></i></span> <select id="id_membro"
										name="id_membro" class="form-control selectpicker">
							...
							<input type="button" id="adicionaDizimoOferta" value="Adicionar">
						</div>
