		...
		<div class="row">
			<div class="col-sm-3 col-md-2 sidebar">
				<ul class="nav nav-sidebar">
					...
					<li><a href="tadelbuscaData">Tadel por Data</a></li>
					<li><a href="tadelPorPeriodo">Membros do Tadel por Período</a></li>
				</ul>
			</div>
			<div class="col-sm-9 main">
				<form:form class="well form-horizontal" id="formulario"
					action="listPessoasPorCelulaSemana" method="post">
					<fieldset>
						<legend>Busca Celula da Semana por Data</legend>
							...
							<div class="col-md-4 inputGroupContainer">
								<div class="input-group">
									<span class="input-group-addon"><i
										...
										name="data" placeholder="dd/MM/yyyy" class="form-control dateP"
										type="text">
								</div>
							</div>
						</div>
						...
						<div class="form-group">
							...
							<div class="col-md-4">
								<button type="submit" class="btn btn-warning">
									Buscar<span class="glyphicon glyphicon-send"></span>
								</button>
							</div>
						</div>
					</fieldset>
