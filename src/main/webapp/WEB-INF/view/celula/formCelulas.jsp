	...
	<div class="container-fluid">
		<div class="row">
			...
			<div class="col-sm-9 main">
				...
				<form class="well form-horizontal" action="salvaCelulas"
					method="post" id="foumlario_celulas">
					<fieldset>
						<legend>Cadastro de Células</legend>
						<div class="form-group">
							<label class="col-md-4 control-label">Nome da Célula</label>
							<div class="col-md-4 inputGroupContainer">
								<div class="input-group">
									<span class="input-group-addon"><i
										class="glyphicon glyphicon-user"></i></span> <input
										name="nome_celula" placeholder="Nome da Célula"
						...
						<div class="form-group">
							...
							<div class="col-md-4 inputGroupContainer">
								<div class="input-group">
									<span class="input-group-addon"><i
										class="glyphicon glyphicon-user"></i></span> <input
										name="nome_anfitriao" placeholder="Nome Completo"
										class="form-control" type="text">
								</div>
							</div>
						</div>
							...
							<div class="col-md-4 inputGroupContainer">
								<div class="input-group">
									<span class="input-group-addon"><i
										...
										name="endereco_celula" placeholder="Endereço"
										class="form-control" type="text">
								</div>
							</div>
						</div>
