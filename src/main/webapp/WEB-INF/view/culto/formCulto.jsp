		...
		<div class="row">
			<div class="col-sm-3 col-md-2 sidebar">
				<ul class="nav nav-sidebar">
					<li><a href="cadastroCulto">Cadastro de Culto</a></li>
					<li><a href="listaCulto">Lista de Culto</a></li>
				</ul>
			</div>
			<div class="col-sm-9 main">

				<form class="well form-horizontal" action="saveCulto" method="post"
					id="foumlario_celulas">
					<fieldset>
						<legend>Cadastro de Culto</legend>
						<div class="form-group">
							<label class="col-md-4 control-label">Tema do Culto</label>
							<div class="col-md-4 inputGroupContainer">
								<div class="input-group">
									<span class="input-group-addon"><i
										class="glyphicon glyphicon-list-alt"></i></span> <input
										name="tema_culto" placeholder="Tema do Culto"
										class="form-control" type="text">
								</div>
							</div>
						</div>
						<div class="form-group">
							<label class="col-md-4 control-label">Data do Culto</label>
							<div class="col-md-4 inputGroupContainer">
								<div class="input-group">
									<span class="input-group-addon"><i
										class="glyphicon glyphicon-calendar"></i></span> <input
										name="data_culto" placeholder="dd/MM/yyyy"
						...
						<div class="form-group">
							...
							<div class="col-md-4 inputGroupContainer">
								<div class="input-group">
									<span class="input-group-addon"><i
										class="glyphicon glyphicon-user"></i></span> <input name="membros"
										placeholder="Total de Membros" class="form-control"
										type="text">
								</div>
							</div>
						</div>
						<div class="form-group">
							...
							<div class="col-md-4 inputGroupContainer">
								<div class="input-group">
									<span class="input-group-addon"><i
										class="glyphicon glyphicon-user"></i></span> <input name="visitantes"
										placeholder="Total de Visitantes" class="form-control"
										type="text">
								</div>
							</div>
						</div>
